...
MATCH_DISPLAY_LABELS={'goals':'Gols','shots':'Finalizações','shots_on_target':'Finalizações a gol','woodwork':'Finalizações na trave','effectivetackles':'Desarmes','corners':'Escanteios','fouls':'Faltas','saves':'Defesas do goleiro','player_throws':'Laterais','yellow_cards':'Cartões amarelos','red_cards':'Cartões vermelhos','offsides':'Impedimentos','goal_kicks':'Tiros de meta','passes_completed':'Passes certos'}
MATCH_METRIC_ALIASES={'goals':'goals','shots':'shots','totalshots':'shots','total_shots':'shots','shots_total':'shots','shots_attempted':'shots','shotsattempted':'shots','shot_attempts':'shots','remates':'shots','chutes':'shots','finalizacoes':'shots','finalizacoes_totais':'shots','shots_on_target':'shots_on_target','shotsontarget':'shots_on_target','shots_on_goal':'shots_on_target','finalizacoes_no_alvo':'shots_on_target','finalizacoes_no_gol':'shots_on_target','finalizacoes_certas':'shots_on_target','chutes_no_alvo':'shots_on_target','woodwork':'woodwork','shots_woodwork':'woodwork','shotswoodwork':'woodwork','finalizacoes_na_trave':'woodwork','finalizacoes_trave':'woodwork','na_trave':'woodwork','bola_na_trave':'woodwork','bolas_na_trave':'woodwork','traves':'woodwork','effectivetackles':'effectivetackles','effective_tackles':'effectivetackles','totaltackles':'effectivetackles','total_tackles':'effectivetackles','tackles':'effectivetackles','tackles_total':'effectivetackles','desarmes':'effectivetackles','desarmes_totais':'effectivetackles','desarmes_efetivos':'effectivetackles','corners':'corners','corner':'corners','corner_kicks':'corners','corners_total':'corners','corners_won':'corners','corner_won':'corners','corner_wins':'corners','woncorners':'corners','won_corners':'corners','escanteios':'corners','escanteios_total':'corners','escanteios_ganhos':'corners','cantos':'corners','fouls':'fouls','foulscommitted':'fouls','fouls_committed':'fouls','faltas':'fouls','faltas_cometidas':'fouls','saves':'saves','keeper_saves':'saves','goalkeeper_saves':'saves','defesas':'saves','defesas_do_goleiro':'saves','defesas_goleiro':'saves','player_throws':'player_throws','throws':'player_throws','throw_ins':'player_throws','throwins':'player_throws','laterais':'player_throws','laterais_total':'player_throws','arremessos_laterais':'player_throws','arremesso_lateral':'player_throws','yellowcards':'yellow_cards','yellow_card':'yellow_cards','yellow_cards':'yellow_cards','total_yellow_cards':'yellow_cards','yellow_cards_total':'yellow_cards','cartoes_amarelos':'yellow_cards','redcards':'red_cards','red_card':'red_cards','red_cards':'red_cards','total_red_cards':'red_cards','red_cards_total':'red_cards','cartoes_vermelhos':'red_cards','offsides':'offsides','offside':'offsides','impedimentos':'offsides','goal_kicks':'goal_kicks','goalkicks':'goal_kicks','goal_kicks_total':'goal_kicks','tiros_de_meta':'goal_kicks','tiros_meta':'goal_kicks','tiro_de_meta':'goal_kicks','passes_completed':'passes_completed','passescompleted':'passes_completed','accuratepasses':'passes_completed','accurate_passes':'passes_completed','passesaccurate':'passes_completed','passes':'passes_completed','total_passes':'passes_completed','totalpasses':'passes_completed','completions':'passes_completed','completedpasses':'passes_completed','completed_passes':'passes_completed','successfulpasses':'passes_completed','successful_passes':'passes_completed','passing_completions':'passes_completed','passing_completion':'passes_completed','total_passes_completed':'passes_completed','totalpassescompleted':'passes_completed','passes_certos':'passes_completed','passes_completos':'passes_completed','passes_precisos':'passes_completed','passes_acertados':'passes_completed'}
PLAYER_METRICS=PLAYER_DISPLAY_LABELS.copy();METRICS=MATCH_DISPLAY_LABELS.copy();SOURCE_PRIORITY={'Dados Futebol':0,'FotMob':1,'ESPN':2,'API-Football':3,'Football-Data.org':4}
def _key(name):
 s=str(name or '').strip();s=re.sub(r'([a-z0-9])([A-Z])',r'\1_\2',s);return re.sub(r'[^A-Za-z0-9]+','_',s).strip('_').lower()
...
def normalize_metric(name):return normalize_match_metric(name)
def average(values):
