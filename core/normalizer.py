...
METRICS = {
    "goals":"Gols", "shots":"Finalizações totais", "shots_on_target":"Finalizações no alvo",
    ...
    "red_cards":"Cartões vermelhos", "saves":"Defesas do goleiro", "woodwork":"Finalizações na trave",
    ...
    "penaltykickgoals":"Gols de pênalti", "penaltykickshots":"Finalizações de pênalti", "player_throws":"Laterais",
...
PLAYER_METRICS = {
    ...
    "keeper_sweeper":"Ações como goleiro-líbero", "long_balls_accurate":"Lançamentos certos", "matchstats.headers.tackles":"Desarmes certos",
    "minutes_played":"Minutos jogados", "offsides":"Impedimentos", "passes_completed":"Passes certos",
    "passes_into_final_third":"Passes para o terço final", "player_throws":"Laterais", "punches":"Socos/afastamentos",
...
# Conjunto fechado da interface: somente estas métricas são exibidas.
MATCH_DISPLAY_ORDER = [
    "goals", "shots", "shots_on_target", "woodwork", "effectivetackles", "corners",
    "fouls", "saves", "player_throws", "yellow_cards", "red_cards", "offsides",
    "goal_kicks", "passes_completed"
]
MATCH_DISPLAY_LABELS = {
    "goals":"Gols", "shots":"Finalizações totais", "shots_on_target":"Finalizações no alvo",
    "woodwork":"Finalizações na trave", "effectivetackles":"Desarmes efetivos", "corners":"Escanteios",
    "fouls":"Faltas", "saves":"Defesas do goleiro", "player_throws":"Laterais",
    "yellow_cards":"Cartões amarelos", "red_cards":"Cartões vermelhos", "offsides":"Impedimentos",
    "goal_kicks":"Tiros de meta", "passes_completed":"Passes certos"
}

PLAYER_DISPLAY_ORDER = [
    "goals", "assists", "passes_completed", "tackles", "fouls", "was_fouled", "shots_on_target", "shots"
]
PLAYER_DISPLAY_LABELS = {
    "goals":"Gols", "assists":"Assistências", "passes_completed":"Passes certos",
    "tackles":"Desarmes certos", "fouls":"Faltas cometidas", "was_fouled":"Faltas sofridas",
    "shots_on_target":"Finalizações no alvo", "shots":"Finalizações"
}

# Normalização de aliases: evita que a mesma estatística apareça duas ou mais vezes.
MATCH_METRIC_ALIASES = {
    ...
    "woodwork":"woodwork", "shots_woodwork":"woodwork", "shotswoodwork":"woodwork",
    "effectivetackles":"effectivetackles", "effective_tackles":"effectivetackles",
    "totaltackles":"effectivetackles", "total_tackles":"effectivetackles",
    "corners":"corners", "corner_kicks":"corners", "woncorners":"corners",
    "fouls":"fouls", "foulscommitted":"fouls", "fouls_committed":"fouls",
    "saves":"saves", "keeper_saves":"saves", "goalkeeper_saves":"saves",
    "player_throws":"player_throws", "throws":"player_throws", "throw_ins":"player_throws",
    "yellowcards":"yellow_cards", "yellow_cards":"yellow_cards",
    "redcards":"red_cards", "red_cards":"red_cards",
    "offsides":"offsides", "goal_kicks":"goal_kicks", "goalkicks":"goal_kicks",
...
PLAYER_METRIC_ALIASES = {
    ...
    "matchstats.headers.tackles":"tackles", "effectivetackles":"tackles", "effective_tackles":"tackles",
    "fouls":"fouls", "foulscommitted":"fouls", "fouls_committed":"fouls",
...
# Preferimos uma única fonte por métrica; nunca somamos valores de fontes diferentes.
