...
PLAYER_DISPLAY_ORDER=['goals','assists','shots_on_target','shots','passes_completed','tackles','fouls','was_fouled']
PLAYER_DISPLAY_LABELS={'goals':'Gols','assists':'Assistências','shots_on_target':'Finalizações certas','shots':'Finalizações no gol','passes_completed':'Passes certos','tackles':'Desarmes','fouls':'Faltas cometidas','was_fouled':'Faltas sofridas'}
PLAYER_METRIC_ALIASES={'goals':'goals','goal':'goals','goals_scored':'goals','total_goals':'goals','assists':'assists','assist':'assists','total_assists':'assists','assists_total':'assists','shots':'shots','total_shots':'shots','shots_total':'shots','shotsattempted':'shots','shots_attempted':'shots','shot_attempts':'shots','shots_on_target':'shots_on_target','shotsontarget':'shots_on_target','shots_on_goal':'shots_on_target','shots_on_target_total':'shots_on_target','shotsontargettotal':'shots_on_target','shots_on_target_attempts':'shots_on_target','accurate_passes':'passes_completed','accuratepasses':'passes_completed','passes_accurate':'passes_completed','passesaccurate':'passes_completed','passes_completed':'passes_completed','completed_passes':'passes_completed','total_passes_completed':'passes_completed','accurate_pass':'passes_completed','passes':'passes_completed','total_passes':'passes_completed','completedpasses':'passes_completed','successful_passes':'passes_completed','tackles':'tackles','total_tackles':'tackles','totaltackles':'tackles','effective_tackles':'tackles','effectivetackles':'tackles','matchstats_headers_tackles':'tackles','matchstats_headers_tackles_total':'tackles','fouls':'fouls','fouls_committed':'fouls','foulscommitted':'fouls','total_fouls':'fouls','fouls_committed_total':'fouls','was_fouled':'was_fouled','fouled':'was_fouled','fouls_suffered':'was_fouled','fouls_suffered_total':'was_fouled'}
POSITION_LABELS={0:'Goleiro',1:'Defensor',2:'Meio-campista',3:'Atacante','GK':'Goleiro','G':'Goleiro','CB':'Zagueiro','RCB':'Zagueiro','LCB':'Zagueiro','DC':'Zagueiro','D':'Defensor','RB':'Lateral-direito','RWB':'Ala-direito','LD':'Lateral-direito','LB':'Lateral-esquerdo','LWB':'Ala-esquerdo','LE':'Lateral-esquerdo','DM':'Volante','CDM':'Volante','MDC':'Volante','CM':'Meio-campista','CM-R':'Meio-campista','CM-L':'Meio-campista','MC':'Meio-campista','AM':'Meia-atacante','CAM':'Meia-atacante','MOC':'Meia-atacante','RM':'Meio-campista','LM':'Meio-campista','RW':'Ponta-direita','LW':'Ponta-esquerda','RF':'Atacante','LF':'Atacante','CF':'Centroavante','ST':'Atacante','FW':'Atacante','F':'Atacante'}
...
def normalize_status(status,completed=None):
 ...
 return 'SCHEDULED'
def normalize_metric(name):return MATCH_METRIC_ALIASES.get(_key(name),_key(name))
def average(values):
