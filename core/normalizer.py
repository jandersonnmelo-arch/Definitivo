...
def normalize_metric(name):
 key=_key(name).lower()
 if key in {'assists','assist','total_assists','assists_total','yellow_card','yellow_cards','yellowcards','red_card','red_cards','redcards','tackles_won','successful_tackles','won_tackles','completions','completed_passes','passes_completed'}:return PLAYER_METRIC_ALIASES.get(key,key)
