...
def build_pre_match_analysis(match,limit=10):
    ...
    # Ataque: xG histórico quando existe. Defesa: gols sofridos históricos do adversário.
    ...
    hxg=average([h_attack,a.get('goals_against')]);axg=average([a_attack,h.get('goals_against')]);p=outcome_probabilities(hxg,axg)
