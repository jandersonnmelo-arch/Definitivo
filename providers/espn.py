...
class ESPNProvider(FootballProvider):
    ...
    def _player_metric(cls, label):
        key = cls._key(label)
        aliases = {
            'g':'goals','goal':'goals','goals_scored':'goals','total_goals':'goals',
            'a':'assists','assist':'assists','goal_assists':'assists','assists_total':'assists',
            'sog':'shots_on_target','shots_on_goal':'shots_on_target','shots_on_target':'shots_on_target','shots_on_target_total':'shots_on_target',
            'shot':'shots','shots':'shots','total_shots':'shots','shots_total':'shots',
            'ac_pass':'passes_completed','ac_passes':'passes_completed','ac_pass_pct':'passes_completed',
            'accurate_pass':'passes_completed','accurate_passes':'passes_completed','accuratepasses':'passes_completed',
            'passes_accurate':'passes_completed','passes_completed':'passes_completed','completed_passes':'passes_completed',
            'passing_completions':'passes_completed','pass_completions':'passes_completed','completions':'passes_completed',
            'tklw':'tackles_won','tkl_w':'tackles_won','tackles_won':'tackles_won','tackleswon':'tackles_won',
            'successful_tackles':'tackles_won','won_tackles':'tackles_won','total_tackles':'tackles','tackles_total':'tackles',
            'tkl':'tackles','tackles':'tackles','effective_tackles':'tackles',
            'fc':'fouls','fouls':'fouls','fouls_committed':'fouls','foulscommitted':'fouls',
            'fa':'was_fouled','fouled':'was_fouled','fouls_suffered':'was_fouled','fouls_suffered_total':'was_fouled',
            'yc':'yellow_cards','yellow_card':'yellow_cards','yellow_cards':'yellow_cards','yellowcards':'yellow_cards',
            'rc':'red_cards','red_card':'red_cards','red_cards':'red_cards','redcards':'red_cards',
            'sv':'saves','saves':'saves','of':'offsides','offsides':'offsides','min':'minutes_played','minutes':'minutes_played','minutes_played':'minutes_played',
        }
            ...
            for group in groups:
                ...
                for item in athletes:
                    ...
                    if pkey not in seen_players:
                        players.append({'id':pid,'team_id':tid,'team_name':tname,'name':name,'position':pos,'source':cls.name}); seen_players.add(pkey)
                    ...
                    for label, value in pairs:
                        ...
                        if skey not in seen_stats:
                            player_stats.append({'player_id':pid,'metric':metric,'value':value,'source':cls.name}); seen_stats.add(skey)
